...
const ProductListScreen = ({ history }) => {
   ...
   }, [history, dispatch, userInfo, success, createdProduct, successCreate]);
   return (
      <>
         ...
         {loadingProductDelete ? (
            ...
            errorProductDelete && <Message variant="danger">{error}</Message>
         )}
         {loadingProductCreate ? (
            <Loader />
         ) : (
            errorProductCreate && <Message variant="danger">{error}</Message>
         )}
         {loadingProducts ? (
            <Loader />
         ) : errorProducts ? (
